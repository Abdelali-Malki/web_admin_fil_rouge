...
<div class="container">
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="name" name="title" value="{{ (old('title'))??$model->title }}">
          ...
          <img class="img-fluid img-thumbnail rounded table-product-image" src='{{ asset("images/color/$model->photo") }}'/>
