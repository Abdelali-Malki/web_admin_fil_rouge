...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-md-7 col-sm-12">
      ...
      <div class="col-md-12 col-sm-12 d-flex justify-content-center align-items-center image-container" style="max-height:500px; height: 500px;">
    ...
    <div class="col-md-5 col-sm-12">
      <form id="product" method="POST" action="{{ route('products-new') }}" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
            ...
            <input type="hidden" class="form-control" id="photo" name="photo" value="{{ old('photo') }}">
          </div>
          ...
          <div class="mb-3">
            ...
            <input class="form-control" id="tags" name="tags" rows="3" value="{{ old('tags') }}" type="text"/>
          </div>
...
<script>
  ...
  $(document).on('keyup', 'input[name="image_path"]', function(){
    var cropper = $image.data('cropper');

    if(typeof(cropper) !== 'undefined')
      cropper.replace($(this).val());
    else{
      $image.cropper({
        aspectRatio: 9 / 20,
        dragMode: 'move',
    ...
    if(typeof(cropper)!=='undefined'){
      ...
      cropper.getCroppedCanvas({
        ...
        $.ajax(tempImageDir, {
          ...
          error(res) {
            swal("Opps!", "Upload error", "warning");
            $('#submitProduct').removeAttr("disabled");
            $('#submitProduct').find('.spinner-border').hide();
          },
        });
      ...
      swal("Opps!", "Please select image", "warning");
      $('#submitProduct').removeAttr("disabled");
      $('#submitProduct').find('.spinner-border').hide();
    }
